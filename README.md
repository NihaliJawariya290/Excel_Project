...
Data Visualization: Created pivot tables, charts, and dashboards to visualize trends in ticket volume, issue categories, and agent performance.
Recommendations: Based on the analysis, actionable insights were provided for software upgrades and targeted agent training to optimize the support ticket process.
